...
public class FeatureSupported : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bool supportsHumanBody3DScaleEstimation = arHumanBodyManager.subsystem.subsystemDescriptor.supportsHumanBody3DScaleEstimation;
        ...
        features.text = $"supportsEyeTracking : {supportsEyeTracking}\n" +
            ...
            $"supportsHumanBody3DScaleEstimation : {supportsHumanBody3DScaleEstimation}\n" +
